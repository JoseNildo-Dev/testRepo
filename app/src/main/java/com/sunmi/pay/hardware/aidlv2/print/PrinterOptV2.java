...
import com.sunmi.pay.hardware.aidlv2.print.PrinterCallbackV2;

/* loaded from: classes.dex */
public interface PrinterOptV2 extends IInterface {

    /* loaded from: classes.dex */
    public static class Default implements PrinterOptV2 {
        @Override // android.os.IInterface
        public IBinder asBinder() {
            return null;
        }

        @Override // com.sunmi.pay.hardware.aidlv2.print.PrinterOptV2
        ...
        @Override // com.sunmi.pay.hardware.aidlv2.print.PrinterOptV2
        public void registerPrintCallback(PrinterCallbackV2 printerCallbackV2) throws RemoteException {
        }
    ...
    void registerPrintCallback(PrinterCallbackV2 printerCallbackV2) throws RemoteException;
    ...
    /* loaded from: classes.dex */
    public static abstract class Stub extends Binder implements PrinterOptV2 {
        private static final String DESCRIPTOR = "com.sunmi.pay.hardware.aidlv2.print.PrinterOptV2";
        ...
        public static PrinterOptV2 asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof PrinterOptV2)) {
                return (PrinterOptV2) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 13:
                    parcel.enforceInterface(DESCRIPTOR);
                    registerPrintCallback(PrinterCallbackV2.Stub.asInterface(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 14:
                    parcel.enforceInterface(DESCRIPTOR);
        ...
        /* loaded from: classes.dex */
        public static class Proxy implements PrinterOptV2 {
            public static PrinterOptV2 sDefaultImpl;
            ...
            public void registerPrintCallback(PrinterCallbackV2 printerCallbackV2) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    obtain.writeStrongBinder(printerCallbackV2 != null ? printerCallbackV2.asBinder() : null);
                    if (!this.mRemote.transact(13, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().registerPrintCallback(printerCallbackV2);
                    } else {
                        obtain2.readException();
                    }
                } finally {
        ...
        public static boolean setDefaultImpl(PrinterOptV2 printerOptV2) {
            if (Proxy.sDefaultImpl != null || printerOptV2 == null) {
                return false;
            }
            Proxy.sDefaultImpl = printerOptV2;
            return true;
        }

        public static PrinterOptV2 getDefaultImpl() {
