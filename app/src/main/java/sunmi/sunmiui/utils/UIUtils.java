...
public class UIUtils {
    ...
    private static void banVolumeKey(Dialog dialog) {
        dialog.setOnKeyListener(new DialogInterface.OnKeyListener() { // from class: sunmi.sunmiui.utils.UIUtils.1
            @Override // android.content.DialogInterface.OnKeyListener
            public boolean onKey(DialogInterface dialogInterface, int i, KeyEvent keyEvent) {
                if (i == 25) {
                    LogUtil.e("onKeyDown", "KEYCODE_VOLUME_DOWN");
                    return true;
                } else if (i == 24) {
                    LogUtil.e("onKeyDown", "KEYCODE_VOLUME_UP");
                    return true;
                } else {
                    return false;
                }
