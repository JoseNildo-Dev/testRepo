...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z2 || i8 + i7 > i9)) {
            i9--;
        }
        int i11 = i9 - i7;
        ...
        while (i15 < i) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (actionMenuPresenter.mStrictWidthLimit) {
                    i3 -= ActionMenuView.measureChildForCells(itemView, i2, i3, makeMeasureSpec, r2);
                } else {
                ...
                boolean z4 = (i11 > 0 || z3) && i14 > 0 && (!actionMenuPresenter.mStrictWidthLimit || i3 > 0);
                boolean z5 = z4;
                if (z4) {
                    ...
                    z4 = z5 & (!actionMenuPresenter.mStrictWidthLimit ? i14 + i13 <= 0 : i14 < 0);
                } else {
                    i4 = i;
                }
                if (z4 && groupId2 != 0) {
